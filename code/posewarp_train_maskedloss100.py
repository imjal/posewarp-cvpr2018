...
def train(model_name, gpu_id):
    ...
    model.compile(optimizer=Adam(lr=1e-4), loss=[networks.vgg_loss(vgg_model, response_weights, 12), networks.vgg_loss(vgg_model, response_weights, 12)], loss_weights = [1.0, 100.0])
